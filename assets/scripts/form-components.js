var FormComponents = function () {
    ...
    var handleDatetimePicker = function () {
        ...
        $(".form_advance_datetime").datepicker({
            isRTL: App.isRTL(),
            format: "dd MM yyyy - hh:ii",
            autoclose: true,
            todayBtn: true,
    ...
    var handleMultiSelect = function () {
        ...
        $('#my_multi_select3').multiSelect({
            selectableHeader: "<input type='text' class='form-control search-input' autocomplete='<off></off>' placeholder='search...'>",
            ...
            afterInit: function (ms) {
                ...
                that.qs1 = $selectableSearch.keypress(selectableSearchString)
                ...
                that.qs2 = $selectionSearch.keypress(selectionSearchString)
                    .on('onclick', function (e) {
                        if (e.which == 40) {
