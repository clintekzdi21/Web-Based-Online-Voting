				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>List of Colleges
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<div class="btn-group">
									...
									<a class="btn btn-default" data-toggle="modal" href="#modal_college" class="config">Add New<i class=""></a>		
