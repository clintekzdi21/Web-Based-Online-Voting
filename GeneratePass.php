				...
				<div class="col-md-12">
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							...
							<!-- <label>
								Search: 
									<input type="text" aria-controls="sample_editable_1" class="">
							</label> -->
							...
							<tr>
								...
								<th font-size:13px; style="display:none">
									 ID #
								</th>
								<th font-size:13px;>
									 Course
...
<div class="footer-tools">
 ...
 <!-- <script type="text/javascript">     
    function PrintDiv() {    
       var divToPrint = document.getElementById('printStudent1');
