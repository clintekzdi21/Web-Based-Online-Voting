...
<!-- BEGIN GLOBAL MANDATORY S{TYLES -->
<link href="assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
<link href="assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
<link href="assets/plugins/uniform/css/u}niform.default.css" rel="stylesheet" type="text/css"/>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>List of Partylist
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<div class="btn-group">
									<a class="btn btn-default" data-toggle="modal" href="#modal_partylists" class="config">Add New<i class=""></a>
							</div>
							...
							<tbody>
							<?php
							include ('partyLoad.php');
							?>
							</tbody>
							<input type="hidden" id="x1" class="form-control input-small" value="">
							</table>
						</div>
					</div>
