...
<div class="page-content-wrapper">
	<div class="page-content-wrapper">
		...
		<div class="alert alert-success">
								...
								Mindanao State University at Naawan Supreme Student Council WEB-BASED VOTING SYSTEM
							</div>
					
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>MSUN-Web Based Voting System
							</div>
							<div class="">
						...
						<div class="portlet-body">
							...
							<div class="tab-content">
								<div class="tab-pane fade active in" id="tab_1_1">
										 ...
										 <img alt="" style="margin-left:30px;" src="assets/img/ssc.jpg">
