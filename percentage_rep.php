		...
		<div class="page-content">
			...
			<div class="invoice">
				...
				<img alt="" style="margin-left:170px;" src="assets/img/print.jpg"></div>
					...
					<ul class="list-unstyled">
					<strong>Percentage Report of Voters</strong></br>
				...
				<div class="row">
					<div class="col-xs-12">
						<table class="table table-striped table-hover" id="tbl_colleges">
						<thead>
						<tr>
							<th>
...
<script type="text/javascript" src="assets/scripts/PercentPerCollege.js"></script>
<script>
