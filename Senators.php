...
<div class="page-content-wrapper">
	<div class="page-content-wrapper">
		...
		<div class="alert alert-success">
								<strong><div style="font-size:35px"></div></strong> 
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-group"></i>Senators
						...
						<!--	<div class ="circular"><img src="" alt=""/></div></div>-->
								...
								<div align="center"><input type="checkbox" id="closeButton " onclick="modal fade" >Senator 1</input></div></div></br></br></br>
