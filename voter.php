	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="">
					<a href="voterhome.html"><i class="fa fa-home"></i>
				...
				<button type="button" style= "width:215"class="btn btn-primary">Submit</button>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
	</div>
...
<div class="page-content-wrapper">
	<div class="page-content-wrapper">
		...
		<div class="alert alert-success">
								...
								Mindanao State University at Naawan ONLINE VOTING SYSTEM
							</div>
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>MSUNovs
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<div class="tab-content">
								<div class="tab-pane fade active in" id="tab_1_1">
										 ...
										 <img alt="" style="margin-left:350px;" src="assets/img/logo1.jpg">
										 
										<p> <div style="margin-left:180px;"><strong>Vision:</strong> An Internationally recognized dynamic institution providing relevant, excellent, and quality education.
										 </div></p>
										 <p><div style="margin-left:180px;"><strong>Mission:</strong> To holistically develop God-fearing manpower resources committed to the core values of integrity, </br><div style="margin-left:60px;">industry, respect to cultural diversity, and environmental sustainability for service excellence.</div></div></p>
								</div>
