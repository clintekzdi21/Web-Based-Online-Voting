	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="">
					<a href="voterhome.html"><i class="fa fa-th"></i>
...
<div class="page-content-wrapper">
	<div class="page-content-wrapper">
		...
		<div class="alert alert-success">
								<div style="font-size:20px">Mindanao State University at Naawan Online Voting System</div>
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-group"></i>President
